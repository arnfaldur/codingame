...
//			result += atk * abilities[Trample] / 3;
//			result += atk * abilities[Drain] / 2;
//			result += def * abilities[Guard] / 2;
//			result += abilities[Lethal] * 4;
//			result += atk * abilities[Charge];
//			result += result * abilities[Ward] / 2;
//			result += myhc / 3;
//			result -= ophc / 3;
//			result += draw;
//		} else {
